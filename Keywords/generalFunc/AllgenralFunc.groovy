...
public class AllgenralFunc {
	...
	@Keyword
	//Updated on 04-09-20
	//Click on Workspace form side navigation bar
	def SwitchtoWorkspace(){
		//Clicks on side menu bar and the clicks on workspace icon
		sideMenuBar()
		TestObject switchToWS = makeTestObject('', '', '', '', '', '', '//i[@class="workspaces_icon"]')
		WebUI.click(switchToWS)
		shortDelay()
