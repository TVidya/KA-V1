...
CustomKeywords.'splitFunc.AllsplitFunc.switchToSplitFrmStd'()
//Apply split
CustomKeywords.'splitFunc.AllsplitFunc.doSplit'(spltattrNM, spltMsrNM, nSep)
CustomKeywords.'generalFunc.AllgenralFunc.longDelay'()



//Validate split
//CustomKeywords.'splitFunc.AllsplitFunc.validSplitData'(splitId,splitAttrNMVal,splitMsrNM,spltexpMsrVal,nSep,vSep)
