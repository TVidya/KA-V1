...
CustomKeywords.'standardFunc.AllstandardFunc.makeDefaultWS'(makeDefaultWS,nSep)

/*
CustomKeywords.'standardFunc.AllstandardFunc.clickOnExpandView'()
CustomKeywords.'standardFunc.AllstandardFunc.clickOnExpandAttrArrow'()
